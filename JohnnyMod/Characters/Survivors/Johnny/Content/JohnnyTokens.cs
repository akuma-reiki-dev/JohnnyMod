...
namespace JohnnyMod.Survivors.Johnny
{
    public static class JohnnyTokens
    {
        ...
        public static void AddJohnnyTokens()
        {
            ...
            #region Passive
            Language.Add(prefix + "PASSIVE_NAME", "Johnny passive");
            ...
            Language.Add(prefix + "SECONDARY_GUN_DESCRIPTION", Tokens.agilePrefix + $"Fire a handgun for <style=cIsDamage>{100f * JohnnyStaticValues.gunDamageCoefficient}% damage</style>.");
            #endregion
            ...
            Language.Add(prefix + "SPECIAL_BOMB_DESCRIPTION", $"Throw a bomb for <style=cIsDamage>{100f * JohnnyStaticValues.bombDamageCoefficient}% damage</style>.");
            #endregion
